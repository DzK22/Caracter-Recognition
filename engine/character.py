...
class Character:
    ...
    def save_positions (self):
        ...
        with open(self.__files_path + self.val, 'w+b') as file:
    ...
    def load_positions (self):
        ...
        try:
            with open(self.__files_path + self.val, 'rb') as file:
    ...
    def delete_positions (self):
        ...
        assert self.positions is not None
        os.remove(self.__files_path + self.val)
